BEGIN;
  ...
  VALUES
    ('dunder', 'Dunder Mifflin', null, '$2a$04$PevBs7XGCfjXgRsqX7C7neWtb2JF0ntFYXJ3jV9TSomsju6hSo5IO'),
    ('b.deboop', 'Bodeep Deboop', 'Bo', '$2a$04$3ITtYXKTo58oGOIP.1dR0.YgY2kyruhwas39WaghS5GknRP7QS1Pa'),
    ('c.bloggs', 'Charlie Bloggs', 'Charlie', '$2a$04$K1J642A9RNZnj5vwUegqn.v4.MqXP0rYMhFfJVke1js3lpp2BFNqy'),
    ('s.smith', 'Sam Smith', 'Sam', '$2a$04$Mf2aHu7k7GUSAorLl/lUceS.mZOcIWpRKwq8YefLky1jyAzzWp6e2'),
    ('lexlor', 'Alex Taylor', 'Lex', '$2a$04$liqVy.AOAV0qnDSiRgXx3ufkKHzw5tBqQF6BerO7eoB629ZhDsrXe'),
    ('wippy', 'Ping Won In', 'Ping', '$2a$04$nu8oWbtVAYNDEWg5mq5L6ucmjf6owkJAbLmPs7Wk8mEGfLh5DyRha');
